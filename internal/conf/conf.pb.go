...
type WxOfficialAccount struct {
	...
	RefreshAccessTokenURL string `protobuf:"bytes,2,opt,name=refreshAccessTokenURL,proto3" json:"refreshAccessTokenURL,omitempty"`
}

func (x *WxOfficialAccount) Reset() {
	*x = WxOfficialAccount{}
	if protoimpl.UnsafeEnabled {
...
func (x *WxOfficialAccount) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WxOfficialAccount) ProtoMessage() {}

func (x *WxOfficialAccount) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WxOfficialAccount.ProtoReflect.Descriptor instead.
func (*WxOfficialAccount) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{3}
}

func (x *WxOfficialAccount) GetAccessTokenURL() string {
	if x != nil {
...
func (x *WxOfficialAccount) GetRefreshAccessTokenURL() string {
	if x != nil {
		return x.RefreshAccessTokenURL
	}
	return ""
}
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*WxOfficialAccount)(nil),   // 3: kratos.api.WxOfficialAccount
...
func file_conf_conf_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_conf_conf_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*WxOfficialAccount); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
